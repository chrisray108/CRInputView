...
- (instancetype)initWithFrame:(CGRect)frame
{
    ...
    if (self) {
        ...
        CRGrowingInternalTextView *textView = [[CRGrowingInternalTextView alloc] initWithFrame:rect];
...
- (instancetype)initWithCoder:(NSCoder *)aDecoder
{
    ...
    if (self) {
        CRGrowingInternalTextView *textView = [[CRGrowingInternalTextView alloc] initWithFrame:CGRectZero];
        self.textView = textView;
